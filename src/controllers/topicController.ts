...
export class TopicController {
  ...
  createTopic = (req: AuthRequest, res: Response, next: NextFunction): void => {
    try {
      ...
      LogUtils.logInfo(SERVICE_NAME, 'createTopic', `Topic created by user ${userId}`, {
        userId,
        role: req.user?.role,
      });
  ...
  updateTopic = (req: AuthRequest, res: Response, next: NextFunction): void => {
    try {
      ...
      LogUtils.logInfo(SERVICE_NAME, 'updateTopic', `Topic updated by user ${userId}`, {
        userId,
        role: req.user?.role,
        topicId: id,
      });
  ...
  setTopicResource = (req: AuthRequest, res: Response, next: NextFunction): void => {
    try {
      ...
      LogUtils.logInfo(SERVICE_NAME, 'setTopicResource', `Resource set by user ${userId}`, {
        userId,
        role: req.user?.role,
        topicId: id,
        resourceType: type,
  ...
  removeTopicResource = (req: AuthRequest, res: Response, next: NextFunction): void => {
    try {
      ...
      LogUtils.logInfo(SERVICE_NAME, 'removeTopicResource', `Resource removed by user ${userId}`, {
        userId,
        role: req.user?.role,
        topicId: id,
      });
  ...
  getShortestPath = (req: AuthRequest, res: Response, next: NextFunction): void => {
    try {
      ...
      LogUtils.logError(SERVICE_NAME, 'getShortestPath', error, {
